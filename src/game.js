...
Object.assign(window, { addMessage,addToInventory,advanceIncubators,applyStatusEffects,assignSkill,autoMoveStep,averageDice,buildAttackDetail,buyShopItem,checkLevelUp,checkMercenaryLevelUp,checkMonsterLevelUp,convertMonsterToMercenary,craftItem,createChampion,createEliteMonster,createHomingProjectile,createItem,createMercenary,createMonster,createSuperiorMonster,createTreasure,dissectCorpse,equipItem,equipItemToMercenary,estimateSkillDamage,findAdjacentEmpty,findPath,formatItem,formatNumber,generateDungeon,generateStars,getAuraBonus,getDistance,getMonsterPoolForFloor,getPlayerEmoji,getStat,getStatusResist,handleDungeonClick,handleItemClick,handlePlayerDeath,hasLineOfSight,healAction,healTarget,hideItemTargetPanel,hideMercenaryDetails,hideMonsterDetails,hideShop,hireMercenary,killMonster,loadGame,meleeAttackAction,monsterAttack,movePlayer,nextFloor,performAttack,pickUpAction,placeEggInIncubator,processMercenaryTurn,processProjectiles,processTurn,purifyTarget,rangedAction,recallMercenaries,recruitHatchedSuperior,removeEggFromIncubator,renderDungeon,reviveMercenary,reviveMonsterCorpse,saveGame,sellItem,setMercenaryLevel,setMonsterLevel,showChampionDetails,showItemTargetPanel,showMercenaryDetails,showMonsterDetails,showShop,showSkillDamage,skill1Action,skill2Action,spawnMercenaryNearPlayer,startGame,swapActiveAndStandby,tryApplyStatus,unequipAccessory,unequipItemFromMercenary,updateActionButtons,updateCamera,updateFogOfWar,updateIncubatorDisplay,updateInventoryDisplay,updateMaterialsDisplay,updateMercenaryDisplay,updateShopDisplay,updateSkillDisplay,updateStats,updateTurnEffects,upgradeMercenarySkill,useItem,useItemOnTarget,useSkill });
export { addMessage,addToInventory,advanceIncubators,applyStatusEffects,assignSkill,autoMoveStep,averageDice,buildAttackDetail,buyShopItem,checkLevelUp,checkMercenaryLevelUp,checkMonsterLevelUp,convertMonsterToMercenary,craftItem,createChampion,createEliteMonster,createHomingProjectile,createItem,createMercenary,createMonster,createSuperiorMonster,createTreasure,dissectCorpse,equipItem,equipItemToMercenary,estimateSkillDamage,findAdjacentEmpty,findPath,formatItem,formatNumber,generateDungeon,generateStars,getAuraBonus,getDistance,getMonsterPoolForFloor,getPlayerEmoji,getStat,getStatusResist,handleDungeonClick,handleItemClick,handlePlayerDeath,hasLineOfSight,healAction,healTarget,hideItemTargetPanel,hideMercenaryDetails,hideMonsterDetails,hideShop,hireMercenary,killMonster,loadGame,meleeAttackAction,monsterAttack,movePlayer,nextFloor,performAttack,pickUpAction,placeEggInIncubator,processMercenaryTurn,processProjectiles,processTurn,purifyTarget,rangedAction,recallMercenaries,recruitHatchedSuperior,removeEggFromIncubator,renderDungeon,reviveMercenary,reviveMonsterCorpse,saveGame,sellItem,setMercenaryLevel,setMonsterLevel,showChampionDetails,showItemTargetPanel,showMercenaryDetails,showMonsterDetails,showShop,showSkillDamage,skill1Action,skill2Action,spawnMercenaryNearPlayer,startGame,swapActiveAndStandby,tryApplyStatus,unequipAccessory,unequipItemFromMercenary,updateActionButtons,updateCamera,updateFogOfWar,updateIncubatorDisplay,updateInventoryDisplay,updateMaterialsDisplay,updateMercenaryDisplay,updateShopDisplay,updateSkillDisplay,updateStats,updateTurnEffects,upgradeMercenarySkill,useItem,useItemOnTarget,useSkill };
